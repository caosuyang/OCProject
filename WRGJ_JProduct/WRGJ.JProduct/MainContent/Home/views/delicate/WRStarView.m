...
#define STAR_GRAY @"star_gray_icon.png"
#define STAR_YELLOW @"star_red_icon.png"
@interface WRStarView()
@property (nonatomic, strong) UIView * frontView;
@property (nonatomic, strong) UIView * backgroundView;
@property (nonatomic, assign) NSInteger numberOfStars;
@property (nonatomic, assign) BOOL isVariable; //星级展示是不是可操作的，默认为YES
@property(nonatomic, strong)UIFont *starFont;
@end

@implementation WRStarView
...
- (UIView *)createStarViewWithImage:(NSString *)imageName {
    ...
    for (NSInteger i = 0; i < self.numberOfStars; i++) {
        ...
        imageView.frame = CGRectMake(i * ((self.bounds.size.width-12)/self.numberOfStars+3), 0, (self.bounds.size.width-12)/self.numberOfStars, self.bounds.size.height);
